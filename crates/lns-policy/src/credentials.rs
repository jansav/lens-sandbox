...
pub fn default_credentials_path() -> PathBuf {
    lns_spec::lns_home().join("credentials.json")
}
...
mod tests {
    ...
    fn default_credentials_path_names_a_file_inside_the_lns_home() {
    ...
    #[test]
    #[serial_test::serial(env)]
    fn default_credentials_path_follows_the_lns_home_override() {
        use crate::test_env::EnvVarGuard;
        let _g1 = EnvVarGuard::set("LNS_HOME", "/srv/lns-state");
        let _g2 = EnvVarGuard::set("HOME", "/home/should-be-ignored");
        assert_eq!(
            default_credentials_path(),
            PathBuf::from("/srv/lns-state/credentials.json"),
