...
pub trait Provider: Send + Sync + 'static {
    ...
    /// Whether the guest seeds this provider's placeholder into the workload env; a connected connector seeds, a merely-connectable one stays detect/offer-only so it cannot pollute the workload env.
